...
# 🔹 Pobranie listy
df = pd.read_csv("C:/Users/Kuba/Desktop/Projects/Music-data-analysis/data/spotify_tracks.csv")
    ...
    with ThreadPoolExecutor(max_workers=NUM_THREADS) as executor:
        ...
        for future in futures:
            ...
            if counter % SAVE_EVERY == 0:
                pd.DataFrame(lyrics_data).to_csv("C:/Users/Kuba/Desktop/Projects/Music-data-analysis/data/test.csv",
                                                 index=False)
                print(f"\n✅ Zapisano {counter} piosenek!")

# 🔹 Finalny zapis
pd.DataFrame(lyrics_data).to_csv("C:/Users/Kuba/Desktop/Projects/Music-data-analysis/data/test.csv", index=False)
